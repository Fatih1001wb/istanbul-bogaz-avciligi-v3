...
export const APP_NAME = 'MaviRota'
export const APP_TAGLINE = 'Doğru zaman, doğru nokta, doğru av.'
export const APP_DESCRIPTION =
  'Türkiye kıyıları için akıllı balıkçılık rehberi — türler, kurallar, hava ve av noktaları.'
